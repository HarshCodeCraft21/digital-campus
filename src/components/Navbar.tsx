    ...
    <nav className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      ...
      {menuOpen && (
        <div className="md:hidden border-t bg-background p-4 space-y-4">
          ...
          <Link to="/courses" className="block text-sm font-medium hover:text-primary transition-colors">
            Courses
          </Link>
          <Link to="/teach" className="block text-sm font-medium hover:text-primary transition-colors">
            Teach With Us
          </Link>
          <Link to="/mission" className="block text-sm font-medium hover:text-primary transition-colors">
            Our Mission
          </Link>
